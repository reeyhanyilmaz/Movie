                  ...
                  <div key={item.id} className="flex flex-row">
                    ...
                    <div className="w-[274px] h-[137px] flex mr-[25px]">
                      ...
                      <div className="flex flex-col justify-between">
                        <p className="flex justify-center rounded-lg py-1 px-2 text-sm border border-ligthModeBorderColor w-[47px] text-lightGrayTextColor dark:border-[#29282F]">
                          {item.year}
                        </p>
                        <p className="text-base font-bold overflow-hidden overflow-ellipsis whitespace-nowrap w-[150px] dark:text-white">
                          {item.title}
                        </p>
                        <div className="flex">
                          ...
                          {item.genre.map((genre, index) => (
                            <p
                              key={index}
                              className="overflow-hidden overflow-ellipsis whitespace-nowrap text-grayTextColor text-sm flex"
                            >
                              {genre}
              ...
              {series &&
                series.map((item) => (
                  <div key={item.id} className="flex flex-col mb-4">
                    <Image className="rounded-2xl mb-3" src={item.image} width={264} height={390} alt="movie_image" />
